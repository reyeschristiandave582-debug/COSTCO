  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden opacity-15">
          <Image
            src="https://i.imgur.com/VBZsAjk.png"
            alt=""
            width={100}
            height={100}
          ...
          />
          <Image
            src="https://i.imgur.com/Jxo7Hj1.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/1jWavb5.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/mmqt9Ed.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/gN18fTn.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/fx7zmSL.png"
            alt=""
            width={80}
            height={80}
